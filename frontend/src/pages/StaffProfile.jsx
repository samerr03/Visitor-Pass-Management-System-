...
const StaffProfile = () => {
    ...
    if (!user && !fetchError) return (
        <div className="p-8 text-center text-gray-500 flex flex-col items-center justify-center min-h-[50vh] space-y-3">
    ...
    if (!user && fetchError) return (
        <div className="p-8 text-center text-red-500 flex flex-col items-center justify-center min-h-[50vh] space-y-4">
            ...
            <button
                ...
                className="mt-2 px-6 py-2 bg-red-500 text-white rounded-lg shadow hover:bg-red-600 transition-colors focus:ring-2 focus:ring-red-400 focus:outline-none"
            >
                Retry
            </button>
        </div>
